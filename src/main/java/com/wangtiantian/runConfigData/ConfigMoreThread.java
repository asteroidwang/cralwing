        ...
        for (Object o : list) {
            ...
            if (type == 0) {
               if(T_Config_File.method_访问url获取Jsonp普通版("https://carif.api.autohome.com.cn/Car/v3/Param_ListBySpecIdList.ashx?speclist="+ids+"&_appid=test&_=1723037336504&_callback=__param1","GBK",filePath,group+"_params.txt")){
                ...
                if(T_Config_File.method_访问url获取Jsonp普通版("https://carif.api.autohome.com.cn/Car/v2/Config_ListBySpecIdList.ashx?speclist="+ids+"&_=1723037336505&_callback=__config3","GBK",filePath,group+"_config.txt")){
                ...
                if(T_Config_File.method_访问url获取Jsonp普通版("https://carif.api.autohome.com.cn/Car/Config_BagBySpecIdListV2.ashx?speclist="+ids+"&_=1723037336505&_callback=__bag4","GBK",filePath,group+"_bag.txt")){
