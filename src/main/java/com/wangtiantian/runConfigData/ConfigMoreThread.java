...
public class ConfigMoreThread implements Runnable {
    ...
    public ConfigMoreThread(List<Object> list, String filePath, int type, CountDownLatch latch) {
        this.list = list;
    ...
    public void run() {
        ...
        for (Object o : list) {
            ...
            if (type == 0) {
                ...
                if (T_Config_File.method_访问url获取Json普通版("https://carif.api.autohome.com.cn/Car/v2/Config_ListBySpecIdList.ashx?speclist=" + ids + "&_=1723037336505&_callback=__config3", "GBK", filePath, group + "_config.txt")) {
                ...
                if (T_Config_File.method_访问url获取Json普通版("https://carif.api.autohome.com.cn/Car/Config_BagBySpecIdListV2.ashx?speclist=" + ids + "&_=1723037336505&_callback=__bag4", "GBK", filePath, group + "_bag.txt")) {
