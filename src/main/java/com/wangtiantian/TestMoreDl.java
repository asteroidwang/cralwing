...
//        List<Bean_P_C_B_URL> allparamsUrl = DataBaseMethod.getUrlList();
        ...
        for (int i = 0; i < paramsUrl.size(); i++) {
            ...
            Method_MoreThread methodMoreThread = new Method_MoreThread(groupList, "/Users/wangtiantian/MyDisk/所有文件数据/汽车之家/汽车之家_240621_2/config/", ((Bean_P_C_B_URL)groupList.get(i)).get_C_Group());
